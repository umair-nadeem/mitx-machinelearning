...
# load stopwords.txt
stopwords = utils.load_txt('stopwords.txt')
print(stopwords[:5])
...
theta, theta_0 = p1.pegasos(train_bow_features, train_labels, fix_T, fix_L)

test_preds = p1.classify(test_bow_features, theta, theta_0)
test_accs = p1.accuracy(test_preds, test_labels)

print("Best theta: {} and theta_0: {}".format(theta, theta_0))
print("{:50} {:.4f}".format("Test accuracy for Pegasos:", test_accs))
